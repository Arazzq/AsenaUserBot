        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    link = "[Legend Destek Grubu](https://t.me/LegendddSupportt)"
                    text += "İstərsəniz, bunu  deyə bilərsiniz"
                    text += f"- sadece bu mesajı buraya atın {link}.\n"
                    text += "xəta ve Tarix xaricində heçbir şey kaydedilmez\n"

                    ftext = "========== UYARI =========="
                    ftext += "\nBu dosya sadəcə burada yüklendi,"
                    ftext += "\nsadəcə xəta ve tarix qismini kaydettik,"
                    ftext += "\ngizliliğinize hörmət edirik,"
                    ftext += "\nburada hərhansı bir gizli veri varsa"
